...
import model from '../assets/model3mobile.jpg'
...
const Model3 = () => {
  ...
  return (
    <div className='model3 snap-start  w-screen h-screen flex justify-around flex-col items-center text-center gap-8 lg:gap-36' style={styles}> 
    <div className='flex flex-col w-5/6 mx-auto'>
       <h2 className='text-4xl font-san'>Model 3</h2>
